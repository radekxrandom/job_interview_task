...
describe('App', () => {
  test('fetches events from an API and displays them', async () => {
    const events = [
      { id: '1', firstName: 'Hello', lastName: 'Pies', email: 'test@example.com', date: '2021-09-23T00:00:00.000Z'},
      { id: '2', firstName: 'Second', lastName: 'Pies', email: 'test@example.com', date: '2021-09-23T00:00:00.000Z'},
      { id: '3', firstName: 'Third', lastName: 'Pies', email: 'test@example.com', date: '2021-09-23T00:00:00.000Z'},
    ];
  ...
  test('Posting event works', async () => {
    ...
    axios.get.mockImplementationOnce(() =>
     ...
     axios.post.mockImplementationOnce(() =>
      Promise.resolve({ data: {id: '4', firstName: 'test', lastName: 'sec', email: 'test@example.com', date: '2021-09-23T00:00:00.000Z'} })
    );
